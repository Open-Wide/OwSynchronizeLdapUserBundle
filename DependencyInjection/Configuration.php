...
namespace Ow\Bundle\SynchronizeLdapUserBundle\DependencyInjection;
    ...
    public function getConfigTreeBuilder() {
        ...
        $rootNode
                ->children()
                    ...
                    ->scalarNode('event_class')->defaultValue('Ow\Bundle\SynchronizeLdapUserBundle\EventListener\LdapSecuritySubscriber')->end()
                    ->scalarNode('helper_class')->defaultValue('Ow\Bundle\SynchronizeLdapUserBundle\Helper\UserHelper')->end()
